...
import org.geekhub.studentsregistry.domain.exceptions.checked.InvalidStudentNameException;
...
public class NameConsoleReader {
    ...
    private final static StudentsLogger LOG = new StudentsLogger(NameConsoleReader.class.getName());
